...
| Ім'я | Тип | Де живе |
|---|---|---|
| `FRONTEND_WEBHOOK_SECRET` | secret | спільний з приймачем артефактів фронтенду |
| `BACKEND_WEBHOOK_SECRET` | secret | спільний з приймачем деплою бекенду |
...
Секрети у двох приймачів різні — це не недогляд: компрометація одного не має
відкривати другий. Тому в репозиторії вони під різними іменами.
